...
public class CameraFollowObject : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        Vector3 lookToward = TargetObject[gameManager.CurrentTarget].position - transform.position;
        ...
        Vector3 newPos;
        newPos = TargetObject[gameManager.CurrentTarget].position - lookToward.normalized * followDistance;
        newPos.y = TargetObject[gameManager.CurrentTarget].position.y + followHeight;
        ...
        lookToward = TargetObject[gameManager.CurrentTarget].position - transform.position;
